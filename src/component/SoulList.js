        ...
        return (
            <div className="App">
                ...
                <Form className="text-right mt-5">
                    <Form.Group>
                        <Form.Control type="text" value={this.state.inputValue} placeholder="Input Soul Name" onChange={this.onChangeSoul}/>
                    </Form.Group>
                    <Button type="button" variant="dark" onClick={this.addSoul}>Add Soul</Button>{' '}
                </Form>

                <div className="mt-3">
                    <ListGroup>
                        {this.state.nama.map(soul => (
                                <ListGroup.Item key={soul} ><Soul deleteSoul={this.deleteSoul} item={soul}/></ListGroup.Item>
                            )
                        )}
                    </ListGroup>
                </div>
